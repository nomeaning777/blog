---
date: 2026-01-18
slug: swimmer-osint-ctf-2026-writeup
...
sannomiya-1.png: PNG image data, 1408 x 768, 8-bit/color RGB, non-interlaced # AIっぽい
...
tokai-2.png:      PNG image data, 2412 x 1315, 8-bit/color RGB, non-interlaced #AIっぽい、形式が書かれていない。窓の分割数が多いなどの差異
...
Xにヘアピンのfbxファイルを上げているのを見つけた。このファイルをstringsで見てみたところ、C:\Users\shiharu_nagaogi\Documents\modeling\vrc_test\hair_pin\simple_hair_pin.fbx という文字列が見つかったことから、本名をshiharu_nagaogiと推定した。
