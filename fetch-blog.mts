...
n2m.setCustomTransformer("embed", async (block) => {
	...
	console.log("embed");
	return `<blockquote className="twitter-tweet"><a href="${block.embed.url.replace("https://x.com", "https://twitter.com")}" /></blockquote> <script async src="https://platform.twitter.com/widgets.js" />`;
});
